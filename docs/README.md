...
- **Architecture**: [`architecture.md`](./architecture.md) — package boundaries, consumers, data flow and the Gateway connection flow (with diagrams)
...
- **Local development**: [`development.md`](./development.md) — workspace build, tests, docs regeneration
...
- UI tokens, themes, inputs, Gateway connection UI, top bar/drawer/appearance, console islands: [`ui-kit/README.md`](../ui-kit/README.md)
- Chat primitives (thread, composer, markdown/json renderers, assistant panel, workflow chat): [`panel-chat/README.md`](../panel-chat/README.md)
